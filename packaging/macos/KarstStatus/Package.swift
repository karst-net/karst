...
// and `scripts/build-macos-pkg.sh`'s single-architecture build of this
// package, wired into the real installer, have succeeded on a real macos-14
// runner — see the plan doc §2 item 1 for the run. Runtime behavior is still

 ...
 */
public func identityHandle(identityKeyPath: String)throws  -> String?  {
    return try  FfiConverterOptionString.lift(try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_karst_ffi_fn_func_identity_handle(
 ...
 */
public func reEnrollInvitation(invitation: String, configPath: String, stateDir: String)throws   {try rustCallWithError(FfiConverterTypeFfiError_lift) {
    uniffi_karst_ffi_fn_func_re_enroll_invitation(
        FfiConverterString.lower(invitation),
        FfiConverterString.lower(configPath),
        FfiConverterString.lower(stateDir),$0
    )
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_karst_ffi_checksum_func_identity_handle() != 4249) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_karst_ffi_checksum_func_re_enroll_invitation() != 62580) {
        return InitializationResult.apiChecksumMismatch
    }

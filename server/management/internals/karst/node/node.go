...
// with a uniqueness index on the column (`idx_peers_key_unique`). An ML-DSA-65
// public key is 1952 bytes — 2604 characters in base64 — which is not a
...
// HandleLength is the base64 length of a SHA-256 digest: 44 characters, the
// same as a WireGuard public key.
...
// Identity is the Karst-owned row holding a node's full ML-DSA-65 public key.
//
...
type Identity struct {
	...
	// ML-DSA-65 identity key. Authenticates the control channel; deliberately

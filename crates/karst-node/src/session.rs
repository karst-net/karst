...
impl Session {
    ...
    pub fn new(
        ...
        let out_mac_key = FragMacKey::new(&mac1_key(&MlKem::public_key_bytes(&peer.kem_pk)));
        let in_mac_key = FragMacKey::new(&mac1_key(&MlKem::public_key_bytes(&keys.kem_pk)));
        Self {
            keys,
            peer,
            policy,
    ...
    pub fn accept(
        ...
        let expected = karst_noise::handshake::peer_id_hint(&MlKem::public_key_bytes(&peer.kem_pk));
        let (msg2, pending) = respond(
            ...
            |h, _epoch| {
                ...
                Some(PeerPublic {
                    kem_pk: MlKem::public_key_from_bytes(&MlKem::public_key_bytes(&peer.kem_pk))?,
                    dh_pk: peer.dh_pk,
                    psk: peer.psk,
                })
            },
    ...
    pub fn respond_to(
        ...
        // it completes.
        let expected =
            karst_noise::handshake::peer_id_hint(&MlKem::public_key_bytes(&self.peer.kem_pk));

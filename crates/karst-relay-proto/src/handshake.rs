...
/// Produces ML-DSA-87 signatures with this party's identity key.
///
...
/// Verifies ML-DSA-87 signatures against a public key from the roster or the
/// relay registry.
pub trait Verifier {
...
pub struct RosterEntry {
    /// The node's ML-DSA-87 identity key.
...
pub struct RelayEntry {
    /// The peer relay's ML-DSA-87 identity key.
    pub identity_pk: Vec<u8>,
}
...
pub trait Roster {
    ...
    /// A syntactically valid ML-DSA-87 public key that verifies nothing.
    ///
...
mod tests {
    ...
    /// A stand-in for ML-DSA-87 that is deterministic and checkable.
    ///

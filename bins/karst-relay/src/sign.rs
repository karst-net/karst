...
//! The relay's ML-DSA-87 identity — `spec/ponor-v1.md` §5.2 and §5.5.
...
impl Identity {
    ...
    /// The ML-DSA-87 verification key, for publication in the relay registry.
    #[must_use]
...
/// Verifies a peer's ML-DSA-87 signature against a key from the roster or the
/// relay registry.
